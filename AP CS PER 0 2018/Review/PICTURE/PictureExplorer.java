...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  {
    Picture pix = new Picture("Z:\\git\\AP-CS-A\\AP CS PER 0 2018\\Review\\PICTURE\\caterpillar.jpg");
    pix.explore();
    
    Picture butterfly = new Picture("Z:\\git\\AP-CS-A\\AP CS PER 0 2018\\Review\\PICTURE\\butterfly1.jpg");
    
 
    
    butterfly.drawString("I don't always manipulate images, but when I do", 0, 445);
    butterfly.drawString("they look cool", 0, 465);
    butterfly.explore();
  }
