...
public class Deck {
	...
	public Card deal() {
		...
		return (size > 0) ? cards.get(size-- - 1) : null;
	}
...
/*
 * 1. Deck has-a Card 2. It has 6 cards 3. It would be 1-ace for the ranks,
 * diamonds clubs spades hearts for the suits, and values 2-10 for 2-10, 10, 10,
 * 10, 11 4. Yes, since as you loop through the array you want the values to
 * match with the suits and the ranks
 * 
 */
